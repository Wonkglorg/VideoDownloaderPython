...
def main():
    ...
    YTVideoDownloader().download_single_frame_video("https://www.youtube.com/watch?v=3NpjfRKOblg&list=OLAK5uy_nh1X4KzCgR37rgmHGTDx8u_R95S0vX4jA","H:\\Downloads\\Video\\Mp4","H:\\Downloads")
